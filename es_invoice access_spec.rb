    ...
    context 'CD-251620: Document access based on Account group security' do
      ...
      context 'us user restricted the AG2 with segment rules and belongs to COA A' do
        ...
        it 'Invoice doc(with complete/incomplete/partial billing) access based on account group restriction for the users Us User' do
          invoice_numbers = get_data_from_column("Invoice #")
          # invoices(new/pending/approved) with complete billing with satisfying the account group AG2
          expect(invoice_numbers).to include draft_inv_header_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include pending_inv_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include approved_inv_satisfying_AG2.invoice_number
          # Invoice doc(with complete billing where one line satisfies AG2 and the other line does not satisfies the AG2
          expect(invoice_numbers).to include draft_inv_header_one_line_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include pending_inv_one_line_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include approved_inv_one_line_not_satisfying_AG2.invoice_number
          # invoices(new/pending/approved) with complete billing without satisfying the account group AG2
          expect(invoice_numbers).to_not include draft_inv_header_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include pending_inv_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include approved_inv_not_satisfying_AG2.invoice_number
          # invoices(new/pending/approved) with complete billing with satisfying the account group AG2
          expect(invoice_numbers).to include draft_inv_header_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include pending_inv_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include approved_inv_satisfying_AG2.invoice_number
          ...
          expect(invoice_numbers).to include draft_inv_header_split_billing_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include pending_inv_split_billing_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include approved_inv_split_billing_satisfying_AG2.invoice_number
          # Invoice doc(with complete split billing) not satisfies AG2
          expect(invoice_numbers).to_not include draft_inv_header_split_billing_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include pending_inv_split_billing_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include approved_inv_split_billing_not_satisfying_AG2.invoice_number
          # Invoices(new/pending/approved) with partial(by left one segment as blank) billing with satisfying the account group AG2
          expect(invoice_numbers).to include draft_partial_blank_inv_header_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include pending_partial_blank_inv_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include approved_partial_blank_inv_satisfying_AG2.invoice_number
          # Invoices(new/pending/approved) with partial(by left one segment as blank) billing without satisfying the account group AG2'
          expect(invoice_numbers).to_not include draft_partial_blank_inv_header_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include pending_partial_blank_inv_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include approved_partial_blank_inv_not_satisfying_AG2.invoice_number
          ...
          expect(invoice_numbers).to include draft_partial_inv_header_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include pending_partial_inv_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include approved_partial_inv_satisfying_AG2.invoice_number
          ...
          expect(invoice_numbers).to_not include draft_partial_inv_header_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include pending_partial_inv_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include approved_partial_inv_not_satisfying_AG2.invoice_number
          # Invoice with incomplete billing
          expect(invoice_numbers).to include draft_incomplete_billing_inv_header.invoice_number
        end
      end
      ...
      context 'Austria User restricted the AG4 with segment rules and belongs to COA B' do
        ...
        it 'Invoice doc(with complete/incomplete/partial billing) access based on account group restriction for the Austria User' do
          invoice_numbers = get_data_from_column("Invoice #")
          # invoices(new/pending/approved) with complete billing with satisfying the account group AG2
          expect(invoice_numbers).to_not include draft_inv_header_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include pending_inv_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include approved_inv_satisfying_AG2.invoice_number
          # Invoice doc(with complete billing where one line satisfies AG2 and the other line does not satisfies the AG2
          expect(invoice_numbers).to_not include draft_inv_header_one_line_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include pending_inv_one_line_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include approved_inv_one_line_not_satisfying_AG2.invoice_number
          # invoices(new/pending/approved) with complete billing without satisfying the account group AG2
          expect(invoice_numbers).to_not include draft_inv_header_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include pending_inv_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include approved_inv_not_satisfying_AG2.invoice_number
          ...
          expect(invoice_numbers).to_not include approved_inv_not_satisfying_AG2.invoice_number
          # Invoice doc(with complete split billing) satisfies AG2
          expect(invoice_numbers).to_not include draft_inv_header_split_billing_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include pending_inv_split_billing_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include approved_inv_split_billing_satisfying_AG2.invoice_number
          # Invoice doc(with complete split billing) not satisfies AG2
          expect(invoice_numbers).to_not include draft_inv_header_split_billing_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include pending_inv_split_billing_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include approved_inv_split_billing_not_satisfying_AG2.invoice_number
          # Invoices(new/pending/approved) with partial(by left one segment as blank) billing with satisfying the account group AG2
          expect(invoice_numbers).to_not include draft_partial_blank_inv_header_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include pending_partial_blank_inv_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include approved_partial_blank_inv_satisfying_AG2.invoice_number
          # Invoices(new/pending/approved) with partial(by left one segment as blank) billing without satisfying the account group AG2'
          expect(invoice_numbers).to_not include draft_partial_blank_inv_header_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include pending_partial_blank_inv_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include approved_partial_blank_inv_not_satisfying_AG2.invoice_number
          # invoices(new/pending/approved) with partial(by inactivating the lookup value) billing with satisfying the account group AG2'
          expect(invoice_numbers).to_not include draft_partial_inv_header_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include pending_partial_inv_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include approved_partial_inv_satisfying_AG2.invoice_number
          # invoices(new/pending/approved) with partial(by inactivating the lookup value) billing without satisfying the account group AG2'
          expect(invoice_numbers).to_not include draft_partial_inv_header_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include pending_partial_inv_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to_not include approved_partial_inv_not_satisfying_AG2.invoice_number
      ...
      context 'Fiji User restricted to default chart of account(COA A) restriction' do
        ...
        it 'Invoice doc(with complete/incomplete/partial billing) access based on account group restriction for the Fiji User' do
          ...
          expect(invoice_numbers).to include approved_inv_one_line_not_satisfying_AG2.invoice_number
          # invoices(new/pending/approved) with complete billing without satisfying the account group AG2
          expect(invoice_numbers).to include draft_inv_header_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include pending_inv_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include approved_inv_not_satisfying_AG2.invoice_number
          # invoices(new/pending/approved) with complete billing with satisfying the account group AG2
          expect(invoice_numbers).to include draft_inv_header_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include pending_inv_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include approved_inv_satisfying_AG2.invoice_number
          ...
          expect(invoice_numbers).to include approved_inv_split_billing_satisfying_AG2.invoice_number
          # Invoice doc(with complete split billing) not satisfies AG2
          expect(invoice_numbers).to include draft_inv_header_split_billing_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include pending_inv_split_billing_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include approved_inv_split_billing_not_satisfying_AG2.invoice_number
          # Invoices(new/pending/approved) with partial(by left one segment as blank) billing with satisfying the account group AG2
          expect(invoice_numbers).to include draft_partial_blank_inv_header_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include pending_partial_blank_inv_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include approved_partial_blank_inv_satisfying_AG2.invoice_number
          # Invoices(new/pending/approved) with partial(by left one segment as blank) billing without satisfying the account group AG2'
          expect(invoice_numbers).to include draft_partial_blank_inv_header_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include pending_partial_blank_inv_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include approved_partial_blank_inv_not_satisfying_AG2.invoice_number
          # invoices(new/pending/approved) with partial(by inactivating the lookup value) billing with satisfying the account group AG2'
          expect(invoice_numbers).to include draft_partial_inv_header_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include pending_partial_inv_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include approved_partial_inv_satisfying_AG2.invoice_number
          # invoices(new/pending/approved) with partial(by inactivating the lookup value) billing without satisfying the account group AG2'
          expect(invoice_numbers).to include draft_partial_inv_header_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include pending_partial_inv_not_satisfying_AG2.invoice_number
          expect(invoice_numbers).to include approved_partial_inv_not_satisfying_AG2.invoice_number
          # Invoice with incomplete billing
          expect(invoice_numbers).to include draft_incomplete_billing_inv_header.invoice_number
        end
      end
      context 'Colombia User restricted to default chart of account(COA B) restriction' do
        ...
        it 'Invoice doc(with complete/incomplete/partial billing) access based on account group restriction for the Colombia User' do
          #this colombia user cannot see any invoice belongs COA A billing Since he/she is restricted ti default COA (COA B)
          csv = CSV.parse(response.body, :headers => true)
          expect(csv.count).to eq 0
        end
      end
      def get_data_from_column(header)
        csv = CSV.parse(response.body, :headers => true)
        csv.by_col[header]
      end
    end
